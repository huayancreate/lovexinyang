...
public class NearTuanGouAdapter extends BaseAdapter {
	...
	public NearTuanGouAdapter(Context context, List<HashMap<String, String>> news) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		cacheView.tv_fen.setText(getItem(position).get("fen")+"("+getItem(position).get("pingjia")+")");
		
		cacheView.tv_oldPrice.getPaint().setFlags(Paint. STRIKE_THRU_TEXT_FLAG ); //÷–º‰∫·œﬂ
		return convertView;
	}
