...
public class GetHomePageTask extends AsyncTask<String, Void, Integer> {
	...
	public GetHomePageTask(PullToRefreshListView ptrlv,Context context,HomePageAdapter adapter) {
		this.mPtrlv = ptrlv;
