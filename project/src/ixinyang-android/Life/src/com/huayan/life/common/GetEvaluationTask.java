...
public class GetEvaluationTask extends AsyncTask<String, Void, Integer> {
	...
	public GetEvaluationTask(PullToRefreshListView ptrlv,Context context,EvaluationAdapter adapter) {
		this.mPtrlv = ptrlv;
	...
	protected void onPostExecute(Integer result) {
		...
		case HTTP_REQUEST_SUCCESS:
			newAdapter.addNews(GetData.getEvaluationList(10));
