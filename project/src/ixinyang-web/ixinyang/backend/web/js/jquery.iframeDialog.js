    ...
    $.fn.iframeDialog = function (options) {
        this.each(function () {
            $(this).unbind('click').click(function (e) {
                e.preventDefault();
                var $div = $("<div/>");
                var $iframe = $('<iframe class="iframeDialog" id="iframeDialogMap" name="iframeDialog{rnd}" frameborder="0" width="100%" height="100%" marginwidth="0" hspace="0" vspace="0" scrolling="no" allowtransparency="true" />');
                if (!options.title) {
